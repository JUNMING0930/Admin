  ...
  <div class="row">
    <div class="col-lg-9 mb-lg-0">
      <div class="card z-index-2">
        ...
        <a href="addstock.php?id=<?php echo $_SESSION['AID'] ?>" class="btn btn-success float-end mb-3"><i class="fa fa-plus"></i> Add New</a>
            ...
            <div class="card z-index-2">
                ...
                <div class="card-body">
                        ...
                        <div class="col">
                            ...
                            <select name="category" class="form-control border border-dark">
                        ...
                        <label for=""><strong>Product</strong></label>
                            <select name="product" class="form-control border border-dark">
                        ...
                        <label for=""><strong>Size</strong></label>
                            <select name="size" class="form-control border border-dark">
