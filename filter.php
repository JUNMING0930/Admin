    ...
    else if(isset($_POST['filterstockbtn']))
    {
        ...
        if($Fil_Cate != NULL)
        {
            if($Fil_Pro != NULL)
            {
                if($Fil_Size != NULL)
                {
                    header("Location: stocks.php?id=$Current_Admin&cate=$Fil_Cate&pro=$Fil_Pro&size=$Fil_Size"); 
                }
                else 
                {
                    header("Location: stocks.php?id=$Current_Admin&cate=$Fil_Cate&pro=$Fil_Pro"); 
                }
            }
        ...
        else
        {
            if($Fil_Pro != NULL)
            {
                if($Fil_Size != NULL)
                {
                    header("Location: stocks.php?id=$Current_Admin&pro=$Fil_Pro&size=$Fil_Size"); 
                }
                else
                {
                    header("Location: stocks.php?id=$Current_Admin&pro=$Fil_Pro"); 
                }
            }
            else if($Fil_Size != NULL)
            {
